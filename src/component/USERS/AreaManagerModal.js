...
const ZonalManagerModal = ({todo}) => {
  ...
  const changeHandler = (e) => {
    ...
    console.log(userdata.AREAMANAGER);
  };
  ...
  return (
    <>
      ...
      >CLICK HERE TO ADD  AREA MANAGER </option>
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title>PERMISSIONS FOR  AREA MANAGER </Modal.Title>
        </Modal.Header>
        <form onSubmit={handleSubmit(submitHandler1)}>
          <Modal.Body>
            <h6>SELECT ONLY FOR  AREA MANAGER</h6>
            <div>
...
export default ZonalManagerModal;
